...
$(document).ready(function () {
    ...
    $.simpleWeather({
        ...
        success: function (weather) {
            ...
            html += '<div class="forecast for-zero"><p class="day">'+weather.forecast[0].day+'&deg;' + weather.units.temp + '</p><p class="left">H</br>'+weather.forecast[0].high+'&deg;' + weather.units.temp + '</p><p class="left">L</br>'+weather.forecast[0].low+'</p><div class="div"></div></div>';
